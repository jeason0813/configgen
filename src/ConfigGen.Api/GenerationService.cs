    ...
    public class GenerationService : IGenerationService
    {
        ...
        public GenerateResult Generate([NotNull] IDictionary<string, string> preferences)
        {
            ...
            if (applyErrors.Any())
            {
                ...
                generationIssues: applyErrors.Select(p => new GenerationIssue(p.Code, "GenerationService", p.Detail)));
            }
            ...
            return new GenerateResult(
                ...
                generationIssues: result.Errors.Select(e => e.ToGenerationIssue()));
        }
            ...
            [NotNull] ConfigurationGeneratorPreferences configuration)
        {
            ...
            var generationIssues = result.Errors.Select(e => e.ToGenerationIssue());

            IEnumerable<GenerationIssue> warnings = Enumerable.Empty<GenerationIssue>();
            if (!generationIssues.Any())
            {
